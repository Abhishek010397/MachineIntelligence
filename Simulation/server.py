...
def run_server():
    ...
    store = ModbusSlaveContext(
        ...
        hr=ModbusSequentialDataBlock(750, [0]*50))  #10001 768
    ...
    identity.VendorName = 'Oztron'
    identity.ProductCode = 'OZ'
    identity.VendorUrl = 'https://oztronenergy.com/'
    identity.ProductName = 'Modbus Sever'
    identity.ModelName = 'Modbus Sever'
